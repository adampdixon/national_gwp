#*************************************************************
# File: 10_Model_Ensemble_Results-combined_scenarios_and_sites_compbaseline-two_climate_scenarios
# Author: Ellen Maas
# Date: June 2022
...
## Bar charts --------------------------------------------------------------------
  ...
  #### N2O - SoilTemp
  g_kbs_daycent_base_n2o_bymgmt_soilt_10cm <- kbs_model_component_daycent_base_bymgmt_piv[
  ...
  g_kbs_daycent_base_n2o_bymgmt_soilt_10cm
  ...
  #### N2O - WFPS
  g_kbs_daycent_base_ch4_bymgmt_ch4_profile <- kbs_model_component_daycent_base_bymgmt_piv[
  ...
  g_kbs_daycent_base_ch4_bymgmt_ch4_profile
  ...
  ##### APSIM --------------------------------------
    ...
    #### N2O - N2O
  g_lrf_apsim_base_n2o_bymgmt_n2o_20cm <- lrf_model_component_apsim_base_bymgmt_piv[
    lrf_model_component_apsim_base_bymgmt_piv$source %in% c("N2O_5cm_pctchg") &
      lrf_model_component_apsim_base_bymgmt_piv$Scenario_Abbrev != "CR",] %>%
    ggplot(aes(x=Scenario_Abbrev, y=vals, fill=Scenario_Abbrev)) +
    geom_col(position="dodge",colour=NA) +
    #ylab("Percent Change from Baseline Management (%)") +
    xlab("") +
  ...
  g_lrf_apsim_base_n2o_bymgmt_n2o_20cm
  
  
  #### N2O - NO3
  g_lrf_apsim_base_n2o_bymgmt_no3_20cm <- lrf_model_component_apsim_base_bymgmt_piv[
  ...
  g_lrf_apsim_base_n2o_bymgmt_no3_20cm
  
  
  #### N2O - SoilT
  g_lrf_apsim_base_n2o_bymgmt_soilt_20cm <- lrf_model_component_apsim_base_bymgmt_piv[
  ...
  g_lrf_apsim_base_n2o_bymgmt_soilt_20cm
  
  #### N2O - SW
  g_lrf_apsim_base_n2o_bymgmt_soilw_20cm <- lrf_model_component_apsim_base_bymgmt_piv[
  ...
  g_lrf_apsim_base_n2o_bymgmt_soilw_20cm
  
  
  # end new graphs ----------------------------------------------------------
  ggsave(filename=paste0(these_results_folder,"/pub_kbs_apsim_base_n2o_bymgmt_n2o_20cm"),
         plot=g_kbs_apsim_base_n2o_bymgmt_n2o_20cm, width=12, height=25, dpi=300)
