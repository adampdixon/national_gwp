...
change_hist_tmin <- round(hist_ys[2] - hist_ys[1],2)
change_base_tmin <- round(baseln_ys[2] - baseln_ys[1],2)
change_ukesm_high_tmin <- round(ukesm_high_ys[2] - ukesm_high_ys[1],2)
...
change_hist_tmax <- round(hist_ys[2] - hist_ys[1],2)
change_base_tmax <- round(baseln_ys[2] - baseln_ys[1],2)
change_ukesm_high_tmax <- round(ukesm_high_ys[2] - ukesm_high_ys[1],2)
...
change_hist_rain <- round(hist_ys[2] - hist_ys[1],3)
change_base_rain <- round(baseln_ys[2] - baseln_ys[1],3)
change_ukesm_high_rain <- round(ukesm_high_ys[2] - ukesm_high_ys[1],3)
