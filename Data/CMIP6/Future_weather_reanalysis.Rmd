...
gfdl_low_reanal$rain_cm <- gfdl_low_raw$rain_cm + ifelse(diff_gfdl_low<0,0,diff_gfdl_low)
gfdl_high_reanal$rain_cm <- gfdl_high_raw$rain_cm + ifelse(diff_gfdl_high<0,0,diff_gfdl_high)
ukesm_low_reanal$rain_cm <- ukesm_low_raw$rain_cm + ifelse(diff_ukesm_low<0,0,diff_ukesm_low)
ukesm_high_reanal$rain_cm <- ukesm_high_raw$rain_cm + ifelse(diff_ukesm_high<0,0,diff_ukesm_high)

gfdl_low_reanal$rain_mm <- gfdl_low_raw$rain_mm + ifelse(diff_gfdl_low<0,0,diff_gfdl_low)
gfdl_high_reanal$rain_mm <- gfdl_high_raw$rain_mm + ifelse(diff_gfdl_high<0,0,diff_gfdl_high)
ukesm_low_reanal$rain_mm <- ukesm_low_raw$rain_mm + ifelse(diff_ukesm_low<0,0,diff_ukesm_low)
ukesm_high_reanal$rain_mm <- ukesm_high_raw$rain_mm + ifelse(diff_ukesm_high<0,0,diff_ukesm_high)
