...
########## KBS ##########
  ...
  # precip change 
kbs_prec_gfdl_low_df <- kbs_gfdl_low[,c("date","gl_rain_cm")]
kbs_prec_gfdl_low_fit <- lm(gl_rain_cm ~ date, data = kbs_prec_gfdl_low_df)
...
##
kbs_prec_gfdl_high_df <- kbs_gfdl_high[,c("date","gh_rain_cm")]
kbs_prec_gfdl_high_fit <- lm(gh_rain_cm ~ date, data = kbs_prec_gfdl_high_df)
...
##
kbs_prec_ukesm_low_df <- kbs_ukesm_low[,c("date","ul_rain_cm")]
kbs_prec_ukesm_low_fit <- lm(ul_rain_cm ~ date, data = kbs_prec_ukesm_low_df)
...
##
kbs_prec_ukesm_high_df <- kbs_ukesm_high[,c("date","uh_rain_cm")]
kbs_prec_ukesm_high_fit <- lm(uh_rain_cm ~ date, data = kbs_prec_ukesm_high_df)
...
########## LRF ##########
  ...
  # precip change 
lrf_prec_gfdl_low_df <- lrf_gfdl_low[,c("date","gl_rain_cm")]
lrf_prec_gfdl_low_fit <- lm(gl_rain_cm ~ date, data = lrf_prec_gfdl_low_df)
...
##
lrf_prec_gfdl_high_df <- lrf_gfdl_high[,c("date","gh_rain_cm")]
lrf_prec_gfdl_high_fit <- lm(gh_rain_cm ~ date, data = lrf_prec_gfdl_high_df)
...
##
lrf_prec_ukesm_low_df <- lrf_ukesm_low[,c("date","ul_rain_cm")]
lrf_prec_ukesm_low_fit <- lm(ul_rain_cm ~ date, data = lrf_prec_ukesm_low_df)
...
##
lrf_prec_ukesm_high_df <- lrf_ukesm_high[,c("date","uh_rain_cm")]
lrf_prec_ukesm_high_fit <- lm(uh_rain_cm ~ date, data = lrf_prec_ukesm_high_df)
