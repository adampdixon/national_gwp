#######################################
# Function: "p_Edit_soc_calib_df_file"
# Author: "Ellen Maas"
# Date: "Nov. 4, 2022"
...
p_Edit_soc_calib_df_file <- function(data_mtx) {
  
  print("Starting p_Edit_soc_calib_df_file")
  
  outfile_name <- paste0(results_path,"calib_soc_df.csv")
  colnames(data_mtx) <- c("year","Observed","Obs_sd","APSIM","Daycent","RothC",
                          "Millennial","treatment_scen")
