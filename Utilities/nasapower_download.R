...
csvdata <- get_power(community = "ag",
                     ...
                     pars = c("PRECTOTCORR",                          ## Precipitation (mm day-1) 
                              ...
                              "ALLSKY_SFC_LW_DWN",                    ## sky shortwave downward irradiance (MJ/m^2/day)
  ...
  mutate(year = YEAR, 
         ...
         LW_radn_MJm2 = ALLSKY_SFC_LW_DWN, # Longwave 
         LW_radn_Ld = ALLSKY_SFC_LW_DWN*0.041868, # convert from MJ/m^2/day to Langley/day
         LW_radn_Wm2 = ALLSKY_SFC_LW_DWN*11.57407407, # convert from MJ/m^2/day to W/m^2/day
         maxt_C = T2M_MAX, 
         mint_C = T2M_MIN,
         rain_mm = PRECTOTCORR,
         ...
         # Longwave
         LW_radn_MJm2 = ifelse(LW_radn_MJm2 == -999, round(abs(mean(LW_radn_MJm2)), digits = 2), LW_radn_MJm2),
         LW_radn_Ld = ifelse(LW_radn_Ld == -999, round(abs(mean(LW_radn_Ld)), digits = 2), LW_radn_Ld), # for Daycent
         LW_radn_Wm2 = ifelse(LW_radn_Wm2 == -999, -99.99, LW_radn_Wm2),  # for DNDC
  ...
  select(year, month, day, dayofyear, radn_MJm2, radn_Ld, radn_Wm2, LW_radn_Ld, LW_radn_Wm2, maxt_C, mint_C, rain_mm, rain_cm, 
