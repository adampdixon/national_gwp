...
# mill_dailyCinput_df<- read.delim(file=paste0(mill_baseinput_filename),sep=" ", check.names=F, header = T)%>%
...
# output_daily_data <- cbind(millC_Mgha_25cm$year,NA,NA,NA,
