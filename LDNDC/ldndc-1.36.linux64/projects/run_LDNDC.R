...
prior_path <- getwd()
model_path = paste0(file.path(prior_path, "LDNDC", 'ldndc-1.36.linux64', 'projects',site_name),"/")
...
system(paste0("chmod 755 ", prior_path, "/LDNDC/ldndc-1.36.linux64/bin/ldndc"))
