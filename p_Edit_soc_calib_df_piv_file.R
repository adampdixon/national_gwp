...
p_Edit_soc_calib_df_piv_file <- function(data_mtx,treatment_scen) {
  
  print("Starting p_Edit_soc_calib_df_piv_file")
  
  outfile_name <- paste0(results_path,"calib_soc_df_piv.csv")
  colnames(data_mtx) <- c("year","Obs_sd","treatment_scen","Model",
                          "yield_val")
