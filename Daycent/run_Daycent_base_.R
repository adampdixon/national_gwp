...
unlink("harvest.csv")
unlink(paste0("harvest_base_",scenario_name,".csv"))  #AD why are all these being deleted?
unlink("livec.out")
...
#file.copy("dc_sip.csv", "dc_sip_base.csv", overwrite=TRUE)
file.copy("harvest.csv", paste0("harvest_base_",scenario_name,".csv"), overwrite=TRUE) #AD appears to be written back here
