...
#    geom_segment(aes(x = Cxs[1], xend = Cxs[2], y = Cys[1], yend = Cys[2]), color=cbPalette9[8]) +
  ...
  NO330cm_fit_time <- lm(NO3_30cm_kgha/100 ~ date, data = NO3_this) #convert to hgha/10
  NO330cm_fit_coef_time <- coef(NO330cm_fit_time)
  NO345cm_fit_time <- lm(NO3_45cm_kgha/100 ~ date, data = NO3_this) #convert to hgha/10
  ...
  SoilT30cm_fit_time <- lm(layer5/100 ~ date, data = SoilT_this)
  SoilT30cm_fit_coef_time <- coef(SoilT30cm_fit_time)
  SoilT45cm_fit_time <- lm(layer6/100 ~ date, data = SoilT_this)
  SoilT45cm_fit_coef_time <- coef(SoilT45cm_fit_time)
  SoilT60cm_fit_time <- lm(layer7/100 ~ date, data = SoilT_this)
  ...
  SoilT10cm_fit_time <- lm(mean_10cm/100 ~ date, data = SoilT_this)
  SoilT10cm_fit_coef_time <- coef(SoilT10cm_fit_time)
  #
