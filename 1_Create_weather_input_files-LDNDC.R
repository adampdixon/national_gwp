...
# DNDC_basic <- historic_data2[,c("year","dayofyear","rain_mm","tavg","maxt_C","mint_C",
#                          "radn_Wm2","meanw_ms")]
colnames(clim_data) <- c("year","dayofyear","rain_mm","tavg","maxt_C","mint_C",
                                "radn_Wm2","meanw_ms")

DNDC_basic<-clim_data
