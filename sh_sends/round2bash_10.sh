...
#PBS -N All_r10
#PBS -A UEMO0003
#PBS -o /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_r10.stdout
#PBS -e /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_r10.stderr 
### Queue name
#PBS -q main
