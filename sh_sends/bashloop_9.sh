...
#PBS -N All_9
#PBS -A UEMO0003
#PBS -o /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_9.stdout
#PBS -e /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_9.stderr 
### Queue name
#PBS -q main
