...
#conda activate casper_2023
echo "Hello World run_get_model_tables from $PBS_ARRAY_INDEX"         
CMD="Rscript /glade/derecho/scratch/apdixon/national_gwp/data_explore/run_get_model_tables.R --args $PBS_ARRAY_INDEX >& $PBS_ARRAY_INDEX.log &"
echo $CMD
$CMD
