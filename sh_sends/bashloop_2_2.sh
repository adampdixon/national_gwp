...
#PBS -N All_2_2
#PBS -A UEMO0003
#PBS -o /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_2_2.stdout
#PBS -e /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_2_2.stderr 
### Queue name
#PBS -q main
