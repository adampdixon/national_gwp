...
#PBS -N All_4_1
#PBS -A UEMO0003
#PBS -o /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_4_1.stdout
#PBS -e /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_4_1.stderr 
### Queue name
#PBS -q main
