...
#PBS -N All_16
#PBS -A UEMO0003
#PBS -o /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_16.stdout
#PBS -e /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_16.stderr 
### Queue name
#PBS -q main
