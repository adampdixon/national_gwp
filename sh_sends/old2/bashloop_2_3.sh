...
#PBS -N All_2_3
#PBS -A UEMO0003
#PBS -o /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_2_3.stdout
#PBS -e /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_2_3.stderr 
### Queue name
#PBS -q main
