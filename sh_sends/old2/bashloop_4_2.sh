...
#PBS -N All_4_2
#PBS -A UEMO0003
#PBS -o /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_4_2.stdout
#PBS -e /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_4_2.stderr 
### Queue name
#PBS -q main
...
#PBS -M apdixon@pm.me
### Number of nodes
#PBS -l select=1:ncpus=49:mem=125GB
########################
