...
#PBS -N All_15
#PBS -A UEMO0003
#PBS -o /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_15.stdout
#PBS -e /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_15.stderr 
### Queue name
#PBS -q main
