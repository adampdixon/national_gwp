...
#PBS -N All_r4
#PBS -A UEMO0003
#PBS -o /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_r4.stdout
#PBS -e /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_r4.stderr 
### Queue name
#PBS -q main
