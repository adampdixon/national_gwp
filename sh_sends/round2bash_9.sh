...
#PBS -N All_r9
#PBS -A UEMO0003
#PBS -o /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_r9.stdout
#PBS -e /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_r9.stderr 
### Queue name
#PBS -q main
