...
#PBS -N All_14
#PBS -A UEMO0003
#PBS -o /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_14.stdout
#PBS -e /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_14.stderr 
### Queue name
#PBS -q main
