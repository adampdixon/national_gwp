...
#PBS -N All_r12
#PBS -A UEMO0003
#PBS -o /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_r12.stdout
#PBS -e /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_r12.stderr 
### Queue name
#PBS -q main
