...
#PBS -N All_r13
#PBS -A UEMO0003
#PBS -o /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_r13.stdout
#PBS -e /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_r13.stderr 
### Queue name
#PBS -q main
