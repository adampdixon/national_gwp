...
#PBS -N All_r8
#PBS -A UEMO0003
#PBS -o /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_r8.stdout
#PBS -e /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_r8.stderr 
### Queue name
#PBS -q main
