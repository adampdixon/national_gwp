...
#PBS -N All_13
#PBS -A UEMO0003
#PBS -o /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_13.stdout
#PBS -e /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_13.stderr 
### Queue name
#PBS -q main
