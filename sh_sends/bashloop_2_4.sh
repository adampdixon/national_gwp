...
#PBS -N All_2_4
#PBS -A UEMO0003
#PBS -o /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_2_4.stdout
#PBS -e /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_2_4.stderr 
### Queue name
#PBS -q main
...
#PBS -M apdixon@pm.me
### Number of nodes
#PBS -l select=1:ncpus=47:mem=125GB
########################
