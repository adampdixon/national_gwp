...
#PBS -N All_r7
#PBS -A UEMO0003
#PBS -o /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_r7.stdout
#PBS -e /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_r7.stderr 
### Queue name
#PBS -q main
