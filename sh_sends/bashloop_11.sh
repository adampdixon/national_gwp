...
#PBS -N All_11
#PBS -A UEMO0003
#PBS -o /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_11.stdout
#PBS -e /glade/derecho/scratch/apdixon/national_gwp/sh_sends/day_11.stderr 
### Queue name
#PBS -q main
