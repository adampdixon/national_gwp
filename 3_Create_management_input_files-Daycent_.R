...
ops_txt <- if(mgmt_scenario_grp==3) { 
  ...
  c(
    ...
    paste0("1 225 FERT (",round(0.1*fert_adjust,2),"N)"),
    paste0("1 291 FERT (",round(0.1*fert_adjust,2),"N)"),
    if_else(mgmt_scenario_grp==5, paste0("2 106 CULT H",resid_adjust_chr),
            "2 106 CULT H"),
    if_else(mgmt_scenario_grp==5, paste0("2 126 CULT D",resid_adjust_chr),
            "2 126 CULT D"),
    ...
    if_else(mgmt_scenario_grp==5, paste0("3 130 CULT D",resid_adjust_chr),
            "3 130 CULT D"),
    "3 134 CROP SYBN",
    "3 134 PLTM",
    ...
    paste0("3 208 FERT (",round(0.1*fert_adjust,2),"N)"),
    paste0("3 273 HARV G",resid_adjust_chr,"S"),
    if_else(mgmt_scenario_grp==5, paste0("3 274 CULT H",resid_adjust_chr),
            "3 274 CULT H"),
    "3 313 CROP W4EG",
    "3 313 PLTM"
  )
