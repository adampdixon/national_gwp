...
#PBS -N hisprcp
#PBS -A uemo0003
#PBS -o /glade/work/zhuonan/Output_nClimGrid/job_prcp.stdout 
#PBS -e /glade/work/zhuonan/Output_nClimGrid/job_prcp.stderr 
### Queue name
#PBS -q main
...
Rscript /glade/work/zhuonan/nclimgrid_scripts/HisClimate_data_prcp.R
