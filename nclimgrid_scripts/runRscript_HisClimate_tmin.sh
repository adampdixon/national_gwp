...
#PBS -N histmin
#PBS -A uemo0003
#PBS -o /glade/work/zhuonan/Output_nClimGrid/job_tmin.stdout 
#PBS -e /glade/work/zhuonan/Output_nClimGrid/job_tmin.stderr 
### Queue name
#PBS -q main
...
Rscript /glade/work/zhuonan/nclimgrid_scripts/HisClimate_data_tmin.R
